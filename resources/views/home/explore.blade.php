                ...
                <div class="col-lg-10" style="margin-top:100px;">
                    <div class="filters">
                        <ul>
                            ...
                            <li ><a href="{{ url('cat_search' ,$category->id) }}">{{ $category->cat_title }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="row" style="margin : 30px;">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="search" name="search"
                                placeholder="Search for book title , auther name">
                            ...
                            <div class="col-lg-6 currently-market-item all msc">
                                <div class="item">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <br>
                                        <div class="">
                                            <a class="btn btn-primary" href="{{ url('borrow_book', $data->id) }}">Apply
                                                to
                                                Borrow</a>
                                        </div>
